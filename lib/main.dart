...
// // Create constants
// final String _sdk_key =
//     "45kT4VQU0UG7_N0y2rQ4Afnrbd-xTh-F27IktAuD0E4nt7oBTCRLOyzDIbt8bMFlwk3wQXWiT092k2wwsZNTxW";

// final String _interstitial_ad_unit_id = "66077cfa48467aca";

// final String _rewarded_ad_unit_id = "5f301c02d7e213a0";
// final String _banner_ad_unit_id = "8e37149c086fd15f";
...
//         _interstitialLoadState = AdLoadState.notLoaded;
//         logStatus('Interstitial ad failed to display with code ' +
//             error.code.toString() +
//             ' and message ' +
//             error.message);
//       },
...
//       logStatus('Rewarded ad failed to load with code ' +
//           error.code.toString() +
//           ' - retrying in ' +
//           retryDelay.toString() +
//           's');
...
//     }, onAdDisplayFailedCallback: (ad, error) {
//       _rewardedAdLoadState = AdLoadState.notLoaded;
//       logStatus('Rewarded ad failed to display with code ' +
//           error.code.toString() +
//           ' and message ' +
//           error.message);
//     }, onAdClickedCallback: (ad) {
...
//     }, onAdLoadFailedCallback: (adUnitId, error) {
//       logStatus('MREC ad failed to load with error code ' +
//           error.code.toString() +
//           ' and message: ' +
//           error.message);
//     }, onAdClickedCallback: (ad) {
...
//                                 //
//                                 AppLovinMAX.createBanner(_banner_ad_unit_id,
...
//                                 AppLovinMAX.createMRec(_mrec_ad_unit_id,
//                                     AdViewPosition.bottomCenter);
